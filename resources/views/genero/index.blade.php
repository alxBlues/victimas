                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><a href="javascript:void(0);" class="btn btn-sm btn-primary btn-round" title="" data-toggle="modal" data-target=".edit-{{$genero->id}}-modal">Editar</a></td>
                                  <td>
                                    <a href="{{route('genero.destroy', $genero->id)}}" class="btn btn-sm btn-danger btn-round" onclick="return confirm('¿Seguro desea eliminar?')">Eliminar</a>
                                  </td>
                                  <td>
                                    <!-- Modal editar Hecho Victimizante -->
                                        <div class="modal fade edit-{{$genero->id}}-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                      {{ Form::open(['route' => ['genero.update', $genero->id], 'method' => 'PUT' ]) }}
    ...
    <div class="modal fade new-plan-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  {{ Form::open(['route' => 'genero.store','files' => true ]) }}
