        ...
        <div class="block-header">
          ...
          <div class="row clearfix">
            ...
            <div class="col-md-6 col-sm-12 text-right hidden-xs">
              {{ Form::model($atencionPsicosocial, ['route' => ['psicosocial.update', $atencionPsicosocial->id], 'method' => 'put']) }}

              {{ Form::submit('Guardar', ['class' => 'btn btn-sm btn-primary btn-round']) }}
              <a href="{{route('psicosocial.show', $atencionPsicosocial->id)}}" class="btn btn-sm btn-primary btn-round">Volver</a>
            </div>
          </div>
        </div>
